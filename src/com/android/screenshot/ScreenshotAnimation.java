...
public class ScreenshotAnimation {
	static final String TAG = "GlobalScreenshot";
	 ...
	 */
	public void startAnimation(boolean statusBarVisible, boolean navBarVisible) {
	...
	public void startAnimation(int w, int h, boolean statusBarVisible, boolean navBarVisible) {
